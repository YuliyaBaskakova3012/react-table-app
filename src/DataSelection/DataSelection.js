...
return(
    <div  className="vertical-align text-center">
     <h1 >Таблица с данными</h1> 
       <div class="row">
        <div class="col-md-6"><button className="btn btn-primary col-xs-6" onClick={()=>props.onSelect(smallData)} >32 элемента</button></div>
        <div class="col-md-6"><button className="btn btn-info col-xs-6" onClick={()=>props.onSelect(bigData)}>1000 элементов</button></div>
       </div> 
    </div>
)
}